...
export const ChainCycleLogo: React.FC<IconProps> = (props) => (
...
export const RecycleIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 19H4.815a1.83 1.83 0 0 1-1.57-2.92L5.43 12 3.245 7.92A1.83 1.83 0 0 1 4.815 5H7"/>
    <path d="M10 12h2"/>
    <path d="M17 19h2.185a1.83 1.83 0 0 0 1.57-2.92L18.57 12l2.185-4.08A1.83 1.83 0 0 0 19.185 5H17"/>
    <path d="m12 19 2-4-2-4"/>
    <path d="m12 5 2 4-2 4"/>
  </svg>
);
...
export const BuildingOfficeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 18h.01"/><path d="M12 15h.01"/><path d="M12 12h.01"/><path d="M12 9h.01"/><path d="M12 6h.01"/><path d="M16 9h.01"/><path d="M8 9h.01"/><path d="M16 6h.01"/><path d="M8 6h.01"/><path d="M16 12h.01"/><path d="M8 12h.01"/><path d="M16 15h.01"/><path d="M8 15h.01"/>
    </svg>
);

export const CodeBracketIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9 4.5l-6 6 6 6"/><path d="M15 4.5l6 6-6 6"/><path d="M14 4l-4 16"/>
    </svg>
);
